...
const Nosotros = () => {
  ...
  const equipo = [
    ...
    {
      nombre: "Celina Bono",
      imagen: "/assets/pages/nosotros/celina.jpg",
      linkedin: "https://linkedin.com/in/celina-bono",
      email: "",
    },
    {
      nombre: "Ignacio Iannino",
      imagen: "/assets/pages/nosotros/ignacio.png",
      linkedin: "https://www.linkedin.com/in/nacho-i-9341822a1/",
      email: "",
    },
  ];
            ...
            <div key={index} className="text-center">
              ...
              <div className="mt-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#4e2d1e] rounded-full px-6 py-2 active:scale-[.98] transition duration-300 mx-auto block hover:underline"
                >
                  LinkedIn
                </a>
                <a
