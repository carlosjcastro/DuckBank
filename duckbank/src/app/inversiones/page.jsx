...
import { INVERSION, LOGO } from '/public/assets/global.jsx';
  ...
  export default function Inversiones(){
    ...
    return (
        <>
            <Head>
                <title> Inversiones - DuckBank</title>
                <meta name='viewport' content = 'width=device-width, initial-sacle=1.0' />
                <meta charset = 'UFT-8'/>
                <meta name='robots' content = 'index, follow' />
                <meta 
                name = "description" 
                content="Página de inversiones del homebanking DuckBank, donde podrás acceder a una gran variedad de opciones de inversión. Podés elegir la que más se adapte a tus necesidades y comenzar a invertir en pocos pasos!"/>
                <meta name = 'keywords' content = 'inversiones, DuckBank, fondos mutuos, acciones, plazos fijos, homebanking'/>
                <meta property= 'og:title' content = 'Inversiones - DuckBank' />
                <meta property = 'og:description' content = 'Descubre las mejores opciones de inversión para hacer crecer tu dinero con DuckBank. Ofrecemos una amplia variedad de fondos mutuos, acciones y plazos fijos, con alta rentabilidad y gestión profesional. ¡Comenzá a invertir hoy mismo!' />
