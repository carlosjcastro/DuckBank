...
from .views import SolicitarPrestamoView

from .views import (
    loan_application_view, loan_application_result, loan_history, logout_view,show_client_data, list_cards, list_accounts, AccountViewSet, LoanRequestViewSet, MarcaViewSet, SucursalViewSet, ClienteViewSet, CuentaViewSet, PrestamoViewSet, EmpleadoViewSet, TarjetaViewSet, RegisterView, LoginView
)
...
urlpatterns = [
    ...
    path('solicitar-prestamo/', SolicitarPrestamoView.as_view(), name='solicitar_prestamo'),
]